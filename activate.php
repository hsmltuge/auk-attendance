                ...
                <div class="card card-custom mt-15 mb-15">
                        <div class="card-header flex-wrap py-5">
                            <div class="card-title text-left">
                                ...
                                <div >
                                    ...
                                    <span class="text-uppercase text-primary">Attendance System | Re-Activate Account form</span>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="pb-lg-0 pb-5">
                            <button type="submit" id="kt_login_singin_button"
                                    class="btn btn-primary btn-block font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3"> Send Activation Link
                            </button>
